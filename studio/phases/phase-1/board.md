...
| P1-H06 | F03 | Screenshot map style S1–S5 (390x844, 360x800) บน fixture tile ทั้ง PMTiles และ TileJSON + ทดสอบกลางแดดตาม map-style.md หัวข้อ 10 | build | qa-tester | P1-F02-T06, P1-F02-T11, P1-X05, P1-H07, P1-X23 | `qa/reports/F02/map-style/`, `qa/tests/unit/map-style.test.ts`, `qa/reports/F03/colorblind/` | IN_PROGRESS | — |
